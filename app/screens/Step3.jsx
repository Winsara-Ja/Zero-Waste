...
const Step3 = ({ route, navigation }) => {
  ...
  // Step 3 out of 5 means 60% progress
  const progress = 3 / 5;
  ...
  // Fade in effect and scale animation when the component mounts
  useEffect(() => {
    // Fade in animation
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      {/* Display the third instruction */}
      <Text style={styles.stepText}>Step 3:</Text>
      <Text style={styles.instruction}>{steps[2]}</Text>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Step2', { selectedGarbage, steps })} // Navigate to Step 2
        >
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Step4', { selectedGarbage, steps })}
        >
