...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Import MaterialIcons (or any other icon library you choose)
...
const Step1 = ({ route, navigation }) => {
  const { selectedGarbage, steps } = route.params; // Destructure passed data

  // Step 1 out of 5 means 20% progress
  const progress = 1 / 5;
  ...
  // Fade in and scale animations when the component mounts
  useEffect(() => {
    Animated.parallel([
    ...
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('MyComponent')} // Navigate to SelectPage
        >
