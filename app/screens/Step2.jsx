...
import yourImage from '../../assets/images/step2.png'; // Adjust the path according to your project structure
...
const Step2 = ({ route, navigation }) => {
  ...
  // Step 2 out of 5 means 40% progress
  const progress = 2 / 5;
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      <Text style={styles.instruction}>{steps[1]}</Text>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Step1', { selectedGarbage, steps })} // Navigate to Step 1
        >
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Step3', { selectedGarbage, steps })}
        >
