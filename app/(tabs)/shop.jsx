...
import { db } from '../../firebase/index'; // Import your Firebase configuration
import { collection, getDocs, query, where } from 'firebase/firestore';
import { Ionicons } from '@expo/vector-icons'; // Import an icon library for the plus sign
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        {/** Add Product Button */}
        <TouchableOpacity style={styles.addButton} onPress={() => alert('Add product pressed')}>
      ...
      <FlatList
        ...
        // Use a custom prop to track the current index
